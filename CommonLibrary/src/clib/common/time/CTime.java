 ...
 * @author macchan
 */
public class CTime implements ICTimeOrderable, Serializable {
	...
	public CTime progressed(long millis) {
		return new CTime(this.millis + millis);
	}
	 ...
	 * @return
	 */
	public static CTime chooseAfter(CTime a, CTime b) {
		if (a.after(b)) {
			return a;
		}
		return b;
	 ...
	 * @return
	 */
	public static CTime chooseBefore(CTime a, CTime b) {
		if (a.before(b)) {
			return a;
		}
		return b;
