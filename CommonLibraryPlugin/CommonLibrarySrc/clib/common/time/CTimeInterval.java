 ...
 * 
 */
public class CTimeInterval implements Serializable {
	...
	public CTimeInterval add(CTimeInterval another) {
		return new CTimeInterval(this.time + another.time);
	}

	public CTimeInterval difference(CTimeInterval another) {
		return new CTimeInterval(this.time - another.time);
	}

	public CTimeInterval multiply(double a) {
		return new CTimeInterval((long) (this.time * a));
	}
	...
	public static void main(String[] args) {
		...
		System.out
				.println(new CTimeInterval(1000).add(new CTimeInterval(2000)));
		System.out.println(new CTimeInterval(1000).multiply(0.5));
	}
