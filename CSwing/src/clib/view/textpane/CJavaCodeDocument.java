...
/**
 * http://forum.java.sun.com/thread.jspa?threadID=478422&messageID=2225594
 * JavaCodeDocument
 */
public class CJavaCodeDocument extends DefaultStyledDocument {

	private static final long serialVersionUID = 1L;

	private static Color COMMENT = new Color(63, 127, 95);
	private static Color KEYWORD = new Color(127, 0, 85);
	private static Color LITERAL = new Color(0, 0, 192);
	...
	private static Hashtable<String, Object> keywords;
	...
	public CJavaCodeDocument() {
		...
		StyleConstants.setForeground(comment, COMMENT);
		// StyleConstants.setItalic(comment, true);
		keyword = new SimpleAttributeSet();

		StyleConstants.setForeground(keyword, KEYWORD);
		StyleConstants.setBold(keyword, true);
		quote = new SimpleAttributeSet();

		StyleConstants.setForeground(quote, LITERAL);
	}
